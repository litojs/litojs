...
var Router = class {
  ...
  get(path2, handler) {
    return this.createRoute("GET")(path2, handler);
  }
  post(path2, handler) {
    return this.createRoute("POST")(path2, handler);
  }
  put(path2, handler) {
    return this.createRoute("PUT")(path2, handler);
  }
  patch(path2, handler) {
    return this.createRoute("PATCH")(path2, handler);
  }
  delete(path2, handler) {
    return this.createRoute("DELETE")(path2, handler);
  }
